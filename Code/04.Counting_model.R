...
setwd("/Users/spencerkoury/Desktop")
...
full_experiment_dataset <- read.csv("Pooled_Spencer_Hypoxia.csv")
full_experiment_dataset <- as.matrix(full_experiment_dataset)
# Create matrix to store all optimized outputs of looped Uniform.CxCoM.Likelihood
pooled_Spencer_Hypoxia_outputs <- matrix(nrow=0, ncol=38)
colnames(pooled_Spencer_Hypoxia_outputs)<-c("MLE_X_length",
                               "MLE_x1",
                               "MLE_x2",
                               "MLE_x3",
                               "MLE_x4",
...
for (g in 1:63) {
  single_experimental_unit <- as.numeric(full_experiment_dataset[g,])
  ...
  MLE_Uniform_CxCoM <- matrix(nrow=0, ncol=38)
  ...
  for (v in 1:max_p_value) {
    ...
    MLE_outputs <- c((((Uniform_CxCoM_Table$par[1]+Uniform_CxCoM_Table$par[2]+Uniform_CxCoM_Table$par[3]+Uniform_CxCoM_Table$par[4]+Uniform_CxCoM_Table$par[5])/(2*p[1]))*100),
                     ...
                     Uniform_CxCoM_Table$par[18],
                     Uniform_CxCoM_Table$par[19],
                     Uniform_CxCoM_Table$par[20],
                     Uniform_CxCoM_Table$par[21],
                     Uniform_CxCoM_Table$par[22],
                     Uniform_CxCoM_Table$par[23],
                     Uniform_CxCoM_Table$par[24],
                     Uniform_CxCoM_Table$par[25],
                     Uniform_CxCoM_Table$par[26],
                     Uniform_CxCoM_Table$par[27],
                     Uniform_CxCoM_Table$par[28],
                     Uniform_CxCoM_Table$par[29],
  ...
  pooled_Spencer_Hypoxia_outputs<- rbind(pooled_Spencer_Hypoxia_outputs, df2[1,])
  
}

pooled_Spencer_Hypoxia_outputs

write.csv(pooled_Spencer_Hypoxia_outputs,"/Users/spencerkoury/Desktop/pooled_Spencer_Hypoxia_outputs.csv",row.names = TRUE)
